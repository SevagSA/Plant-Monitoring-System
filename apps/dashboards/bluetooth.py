...
layout = html.Div([
    ...
    html.Div(id='container-devices',
             children='Press to check nearby bluetooth devices.', style={'color': constants.TEXT_COLOR}),
    html.Div(id='container-information',
             children='Press to device information.', style={'color': constants.TEXT_COLOR}),
